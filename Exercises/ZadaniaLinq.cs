...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie12_ParyStudentPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Przedmioty, 
                sz => sz.PrzedmiotId, 
                p => p.Id, 
                (sz, p) => $"{sz.Imie} {sz.Nazwisko} uczęszcza na: {p.Nazwa}");
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Studenci, 
                z => z.StudentId, 
                s => s.Id, 
                (z, s) => new { s.Imie, s.Nazwisko, Ocena = z.OcenaKoncowa.Value })
    ...
    public IEnumerable<string> Wyzwanie01_StudenciZWiecejNizJednymAktywnymPrzedmiotem()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Studenci, 
                g => g.Key, 
                s => s.Id, 
                (g, s) => $"{s.Imie} {s.Nazwisko} | Aktywne przedmioty: {g.Count()}");
    ...
    public IEnumerable<string> Wyzwanie02_PrzedmiotyStartujaceWKwietniuBezOcenKoncowych()
    {
        return DaneUczelni.Przedmioty
            ...
            .Where(x => x.Zapisy.All(z => !z.OcenaKoncowa.HasValue))
            .Select(x => x.Nazwa);
    ...
    public IEnumerable<string> Wyzwanie03_ProwadzacyISredniaOcenNaIchPrzedmiotach()
    {
        return DaneUczelni.Prowadzacy
            .Join(DaneUczelni.Przedmioty, 
                pr => pr.Id, 
                p => p.ProwadzacyId, 
                (pr, p) => new { Prowadzacy = pr, PrzedmiotId = p.Id })
            .Join(DaneUczelni.Zapisy.Where(z => z.OcenaKoncowa.HasValue), 
                x => x.PrzedmiotId, 
                z => z.PrzedmiotId, 
                (x, z) => new { x.Prowadzacy.Imie, x.Prowadzacy.Nazwisko, Ocena = z.OcenaKoncowa.Value })
            .GroupBy(x => new { x.Imie, x.Nazwisko })
            .Select(g => $"{g.Key.Imie} {g.Key.Nazwisko} | Średnia studentów: {g.Average(x => x.Ocena):F2}");
    ...
    public IEnumerable<string> Wyzwanie04_MiastaILiczbaAktywnychZapisow()
    {
        return DaneUczelni.Studenci
            ...
            .Select(g => $"Miasto: {g.Key} | Liczba aktywnych zapisów: {g.Count()}");
